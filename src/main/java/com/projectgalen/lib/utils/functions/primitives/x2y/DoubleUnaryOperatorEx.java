...
// ================================================================================================================================
//     PROJECT: PGUtilities
//    FILENAME: DoubleUnaryOperatorEx.java
//         IDE: IntelliJ IDEA
//      AUTHOR: Galen Rhodes
//        DATE: June 27, 2024
//
...
/**
 * Represents a function that accepts an double-valued argument and produces a double-valued result.  This is the {@code double}-to-{@code double} primitive specialization for
 ...
 */
@FunctionalInterface
public interface DoubleUnaryOperatorEx<E extends Exception> {
