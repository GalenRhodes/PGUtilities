...
// ================================================================================================================================
//     PROJECT: PGUtilities
//    FILENAME: BiDoublePredicateEx.java
//         IDE: IntelliJ IDEA
//      AUTHOR: Galen Rhodes
//        DATE: July 01, 2024
//
...
/**
 * Represents a predicate (boolean-valued function) of two {@code double}-valued arguments.  This is the double-consuming primitive type specialization of {@link java.util.function.BiPredicate}.
 *
...
public interface BiDoublePredicateEx<E extends Exception> {
     ...
     */
    default @NotNull BiDoublePredicateEx<? extends E> negate() {
        return (double t, double u) -> (!test(t, u));
    }
