 ...
 * {@code (reference, double)} specialization of {@link com.projectgalen.lib.utils.functions.BiConsumerEx}.
 * Unlike most other functional interfaces, {@code ObjDoubleConsumerEx} is
