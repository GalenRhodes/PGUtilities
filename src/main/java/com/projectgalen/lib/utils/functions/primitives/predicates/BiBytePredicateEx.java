...
// ================================================================================================================================
//     PROJECT: PGUtilities
//    FILENAME: BiBytePredicateEx.java
//         IDE: IntelliJ IDEA
//      AUTHOR: Galen Rhodes
//        DATE: July 01, 2024
//
...
/**
 * Represents a predicate (boolean-valued function) of two {@code byte}-valued arguments.  This is the byte-consuming primitive type specialization of {@link java.util.function.BiPredicate}.
 *
...
@FunctionalInterface
public interface BiBytePredicateEx<E extends Exception> {
     ...
     */
    default @NotNull BiBytePredicateEx<? extends E> and(@NotNull BiBytePredicateEx<? extends E> other) {
        return (byte t, byte u) -> (test(t, u) && other.test(t, u));
    }
     ...
     */
    default @NotNull BiBytePredicateEx<? extends E> negate() {
        return (byte t, byte u) -> (!test(t, u));
    }
     ...
     * @throws NullPointerException if other is null
     */
    default @NotNull BiBytePredicateEx<? extends E> or(@NotNull BiBytePredicateEx<? extends E> other) {
        return (byte t, byte u) -> (test(t, u) || other.test(t, u));
    }
}
