 ...
 *
 * <p>This is a functional interface whose functional method is {@link #test(byte)}.</p>
 *
...
public interface BytePredicate {
     ...
     */
    default @NotNull BytePredicate and(@NotNull BytePredicate other) {
     ...
     */
    default @NotNull BytePredicate negate() {
     ...
     * @throws NullPointerException if other is null
     */
    default @NotNull BytePredicate or(@NotNull BytePredicate other) {
        return (value) -> test(value) || other.test(value);
    }
}
