...
/**
 * Represents a function that accepts an long-valued argument and produces a result.  This is the {@code long}-consuming primitive specialization for
 ...
 */
@FunctionalInterface
public interface LongFunctionEx<R, E extends Exception> {
    /**
