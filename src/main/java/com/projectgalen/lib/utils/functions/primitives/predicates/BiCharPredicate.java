...
public interface BiCharPredicate {
     ...
     */
    default @NotNull BiCharPredicate and(@NotNull BiCharPredicate other) {
     ...
     */
    default @NotNull BiCharPredicate negate() {
     ...
     * @throws NullPointerException if other is null
     */
    default @NotNull BiCharPredicate or(@NotNull BiCharPredicate other) {
        return (char t, char u) -> (test(t, u) || other.test(t, u));
    }
}
