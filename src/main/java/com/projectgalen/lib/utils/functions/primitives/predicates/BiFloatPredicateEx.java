...
// ================================================================================================================================
//     PROJECT: PGUtilities
//    FILENAME: BiFloatPredicateEx.java
//         IDE: IntelliJ IDEA
//      AUTHOR: Galen Rhodes
//        DATE: July 01, 2024
//
...
/**
 * Represents a predicate (boolean-valued function) of two {@code float}-valued arguments.  This is the float-consuming primitive type specialization of {@link java.util.function.BiPredicate}.
 *
 * <p>This is a functional interface whose functional method is {@link #test(float, float)}.
 *
...
@FunctionalInterface
public interface BiFloatPredicateEx<E extends Exception> {
     ...
     */
    default @NotNull BiFloatPredicateEx<? extends E> and(@NotNull BiFloatPredicateEx<? extends E> other) {
        return (float t, float u) -> (test(t, u) && other.test(t, u));
    }
     ...
     */
    default @NotNull BiFloatPredicateEx<? extends E> negate() {
        return (float t, float u) -> (!test(t, u));
    }
     ...
     * @throws NullPointerException if other is null
     */
    default @NotNull BiFloatPredicateEx<? extends E> or(@NotNull BiFloatPredicateEx<? extends E> other) {
        return (float t, float u) -> (test(t, u) || other.test(t, u));
    }
}
