...
// ================================================================================================================================
//     PROJECT: PGUtilities
//    FILENAME: BiBooleanPredicate.java
//         IDE: IntelliJ IDEA
//      AUTHOR: Galen Rhodes
//        DATE: July 01, 2024
//
...
public interface BiBooleanPredicate {
     ...
     */
    default @NotNull BiBooleanPredicate and(@NotNull BiBooleanPredicate other) {
     ...
     */
    default @NotNull BiBooleanPredicate negate() {
     ...
     * @throws NullPointerException if other is null
     */
    default @NotNull BiBooleanPredicate or(@NotNull BiBooleanPredicate other) {
        return (boolean t, boolean u) -> (test(t, u) || other.test(t, u));
    }
}
