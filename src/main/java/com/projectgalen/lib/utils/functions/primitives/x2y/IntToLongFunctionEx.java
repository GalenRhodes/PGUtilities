...
// ================================================================================================================================
//     PROJECT: PGUtilities
//    FILENAME: IntToLongFunctionEx.java
//         IDE: IntelliJ IDEA
//      AUTHOR: Galen Rhodes
//        DATE: June 27, 2024
//
...
/**
 * Represents a function that accepts an int-valued argument and produces a long-valued result.  This is the {@code int}-to-{@code long} primitive specialization for
 ...
 */
@FunctionalInterface
public interface IntToLongFunctionEx<E extends Exception> {
