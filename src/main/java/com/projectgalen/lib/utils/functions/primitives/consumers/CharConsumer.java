...
/**
 * Represents an operation that accepts a single {@code char}-valued argument and returns no result.  This is the primitive type specialization of {@link java.util.function.Consumer} for {@code char}.
...
public interface CharConsumer {
    ...
    /**
     * Returns a composed {@code CharConsumer} that performs, in sequence, this operation followed by the {@code after} operation. If performing either operation throws an exception, it is relayed to
     ...
     */
    default @NotNull CharConsumer andThen(@NotNull CharConsumer after) {
        return (char t) -> {
            accept(t);
            after.accept(t);
        };
