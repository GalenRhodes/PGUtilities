...
// ================================================================================================================================
//     PROJECT: PGUtilities
//    FILENAME: BooleanToDoubleFunctionEx.java
//         IDE: IntelliJ IDEA
//      AUTHOR: Galen Rhodes
//        DATE: June 27, 2024
//
 ...
 * double-valued result.  This is the {@code boolean}-to-{@code double} primitive
 ...
 */
@FunctionalInterface
public interface BooleanToDoubleFunctionEx<E extends Exception> {
     ...
     */
    double applyAsDouble(boolean value) throws E;
}
