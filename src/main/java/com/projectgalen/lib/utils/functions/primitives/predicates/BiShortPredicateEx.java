...
// ================================================================================================================================
//     PROJECT: PGUtilities
//    FILENAME: BiShortPredicateEx.java
//         IDE: IntelliJ IDEA
//      AUTHOR: Galen Rhodes
//        DATE: July 01, 2024
//
...
/**
 * Represents a predicate (boolean-valued function) of two {@code short}-valued arguments.  This is the short-consuming primitive type specialization of {@link java.util.function.BiPredicate}.
 *
...
@FunctionalInterface
public interface BiShortPredicateEx<E extends Exception> {
     ...
     */
    default @NotNull BiShortPredicateEx<? extends E> and(@NotNull BiShortPredicateEx<? extends E> other) {
        return (short t, short u) -> (test(t, u) && other.test(t, u));
    }
     ...
     */
    default @NotNull BiShortPredicateEx<? extends E> negate() {
        return (short t, short u) -> (!test(t, u));
    }
     ...
     * @throws NullPointerException if other is null
     */
    default @NotNull BiShortPredicateEx<? extends E> or(@NotNull BiShortPredicateEx<? extends E> other) {
        return (short t, short u) -> (test(t, u) || other.test(t, u));
    }
}
