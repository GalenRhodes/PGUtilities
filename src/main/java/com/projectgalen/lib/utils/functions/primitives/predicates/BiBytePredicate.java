...
public interface BiBytePredicate {
     ...
     */
    default @NotNull BiBytePredicate and(@NotNull BiBytePredicate other) {
     ...
     */
    default @NotNull BiBytePredicate negate() {
     ...
     * @throws NullPointerException if other is null
     */
    default @NotNull BiBytePredicate or(@NotNull BiBytePredicate other) {
        return (byte t, byte u) -> (test(t, u) || other.test(t, u));
    }
}
