...
// ================================================================================================================================
//     PROJECT: PGUtilities
//    FILENAME: LongToDoubleFunctionEx.java
//         IDE: IntelliJ IDEA
//      AUTHOR: Galen Rhodes
//        DATE: June 27, 2024
//
...
/**
 * Represents a function that accepts an long-valued argument and produces a double-valued result.  This is the {@code long}-to-{@code double} primitive specialization for
 ...
 */
@FunctionalInterface
public interface LongToDoubleFunctionEx<E extends Exception> {
