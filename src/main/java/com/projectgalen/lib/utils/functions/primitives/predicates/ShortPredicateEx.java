...
// ================================================================================================================================
//     PROJECT: PGUtilities
//    FILENAME: ShortPredicateEx.java
//         IDE: IntelliJ IDEA
//      AUTHOR: Galen Rhodes
//        DATE: July 01, 2024
//
...
/**
 * Represents a predicate (boolean-valued function) of one {@code short}-valued argument. This is the {@code short}-consuming primitive type specialization of {@link java.util.function.Predicate}.
 *
...
@FunctionalInterface
public interface ShortPredicateEx<E extends Exception> {
     ...
     */
    default @NotNull ShortPredicateEx<? extends E> and(@NotNull ShortPredicateEx<? extends E> other) {
     ...
     */
    default @NotNull ShortPredicateEx<? extends E> negate() {
     ...
     * @throws NullPointerException if other is null
     */
    default @NotNull ShortPredicateEx<? extends E> or(@NotNull ShortPredicateEx<? extends E> other) {
        return (value) -> test(value) || other.test(value);
    }
}
