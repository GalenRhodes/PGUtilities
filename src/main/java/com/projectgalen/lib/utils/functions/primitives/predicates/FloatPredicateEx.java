...
// ================================================================================================================================
//     PROJECT: PGUtilities
//    FILENAME: FloatPredicateEx.java
//         IDE: IntelliJ IDEA
//      AUTHOR: Galen Rhodes
//        DATE: July 01, 2024
//
...
/**
 * Represents a predicate (boolean-valued function) of one {@code float}-valued argument. This is the {@code float}-consuming primitive type specialization of {@link java.util.function.Predicate}.
 *
...
@FunctionalInterface
public interface FloatPredicateEx<E extends Exception> {
     ...
     */
    default @NotNull FloatPredicateEx<? extends E> and(@NotNull FloatPredicateEx<? extends E> other) {
     ...
     */
    default @NotNull FloatPredicateEx<? extends E> negate() {
     ...
     * @throws NullPointerException if other is null
     */
    default @NotNull FloatPredicateEx<? extends E> or(@NotNull FloatPredicateEx<? extends E> other) {
        return (value) -> test(value) || other.test(value);
    }
}
