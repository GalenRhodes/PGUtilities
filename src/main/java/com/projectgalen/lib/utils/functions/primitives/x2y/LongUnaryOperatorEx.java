...
// ================================================================================================================================
//     PROJECT: PGUtilities
//    FILENAME: LongUnaryOperatorEx.java
//         IDE: IntelliJ IDEA
//      AUTHOR: Galen Rhodes
//        DATE: June 27, 2024
//
...
/**
 * Represents a function that accepts an long-valued argument and produces a long-valued result.  This is the {@code long}-to-{@code long} primitive specialization for
 ...
 */
@FunctionalInterface
public interface LongUnaryOperatorEx<E extends Exception> {
