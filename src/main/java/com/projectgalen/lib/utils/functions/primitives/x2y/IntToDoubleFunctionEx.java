...
// ================================================================================================================================
//     PROJECT: PGUtilities
//    FILENAME: IntToDoubleFunctionEx.java
//         IDE: IntelliJ IDEA
//      AUTHOR: Galen Rhodes
//        DATE: June 27, 2024
//
...
/**
 * Represents a function that accepts an int-valued argument and produces a double-valued result.  This is the {@code int}-to-{@code double} primitive specialization for
 ...
 */
@FunctionalInterface
public interface IntToDoubleFunctionEx<E extends Exception> {
