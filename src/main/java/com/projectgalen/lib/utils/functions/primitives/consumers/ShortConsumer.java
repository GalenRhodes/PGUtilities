...
/**
 * Represents an operation that accepts a single {@code short}-valued argument and returns no result.  This is the primitive type specialization of {@link java.util.function.Consumer} for
 * {@code short}.  Unlike most other functional interfaces, {@code ShortConsumer} is expected to operate via side-effects.
 *
...
public interface ShortConsumer {
    ...
    /**
     * Returns a composed {@code ShortConsumer} that performs, in sequence, this operation followed by the {@code after} operation. If performing either operation throws an exception, it is relayed to
