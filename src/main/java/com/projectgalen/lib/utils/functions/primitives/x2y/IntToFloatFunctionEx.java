...
// ================================================================================================================================
//     PROJECT: PGUtilities
//    FILENAME: IntToFloatFunctionEx.java
//         IDE: IntelliJ IDEA
//      AUTHOR: Galen Rhodes
//        DATE: June 27, 2024
//
...
/**
 * Represents a function that accepts an int-valued argument and produces a float-valued result.  This is the {@code int}-to-{@code float} primitive specialization for
 ...
 */
@FunctionalInterface
public interface IntToFloatFunctionEx<E extends Exception> {
