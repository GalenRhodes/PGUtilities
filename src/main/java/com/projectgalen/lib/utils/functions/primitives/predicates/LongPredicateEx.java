...
/**
 * Represents a predicate (boolean-valued function) of one {@code long}-valued argument. This is the {@code long}-consuming primitive type specialization of {@link java.util.function.Predicate}.
 *
...
@FunctionalInterface
public interface LongPredicateEx<E extends Exception> {
     ...
     */
    default @NotNull LongPredicateEx<? extends E> and(@NotNull LongPredicateEx<? extends E> other) {
     ...
     */
    default @NotNull LongPredicateEx<? extends E> negate() {
     ...
     * @throws NullPointerException if other is null
     */
    default @NotNull LongPredicateEx<? extends E> or(@NotNull LongPredicateEx<? extends E> other) {
        return (value) -> test(value) || other.test(value);
    }
}
