...
/**
 * Represents a predicate (boolean-valued function) of one {@code byte}-valued argument. This is the {@code byte}-consuming primitive type specialization of {@link java.util.function.Predicate}.
 *
...
@FunctionalInterface
public interface BytePredicateEx<E extends Exception> {
     ...
     */
    default @NotNull BytePredicateEx<? extends E> and(@NotNull BytePredicateEx<? extends E> other) {
     ...
     */
    default @NotNull BytePredicateEx<? extends E> negate() {
     ...
     * @throws NullPointerException if other is null
     */
    default @NotNull BytePredicateEx<? extends E> or(@NotNull BytePredicateEx<? extends E> other) {
        return (value) -> test(value) || other.test(value);
    }
}
