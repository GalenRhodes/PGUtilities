...
// ================================================================================================================================
//     PROJECT: PGUtilities
//    FILENAME: BiBooleanPredicateEx.java
//         IDE: IntelliJ IDEA
//      AUTHOR: Galen Rhodes
//        DATE: July 01, 2024
//
...
/**
 * Represents a predicate (boolean-valued function) of two {@code boolean}-valued arguments.  This is the boolean-consuming primitive type specialization of {@link java.util.function.BiPredicate}.
 *
...
@FunctionalInterface
public interface BiBooleanPredicateEx<E extends Exception> {
     ...
     */
    default @NotNull BiBooleanPredicateEx<? extends E> and(@NotNull BiBooleanPredicateEx<? extends E> other) {
        return (boolean t, boolean u) -> (test(t, u) && other.test(t, u));
    }
     ...
     */
    default @NotNull BiBooleanPredicateEx<? extends E> negate() {
        return (boolean t, boolean u) -> (!test(t, u));
    }
     ...
     * @throws NullPointerException if other is null
     */
    default @NotNull BiBooleanPredicateEx<? extends E> or(@NotNull BiBooleanPredicateEx<? extends E> other) {
        return (boolean t, boolean u) -> (test(t, u) || other.test(t, u));
    }
}
