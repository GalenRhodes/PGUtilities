...
// ================================================================================================================================
//     PROJECT: PGUtilities
//    FILENAME: BiShortPredicate.java
//         IDE: IntelliJ IDEA
//      AUTHOR: Galen Rhodes
//        DATE: July 01, 2024
//
...
public interface BiShortPredicate {
     ...
     */
    default @NotNull BiShortPredicate and(@NotNull BiShortPredicate other) {
     ...
     */
    default @NotNull BiShortPredicate negate() {
     ...
     * @throws NullPointerException if other is null
     */
    default @NotNull BiShortPredicate or(@NotNull BiShortPredicate other) {
        return (short t, short u) -> (test(t, u) || other.test(t, u));
    }
}
