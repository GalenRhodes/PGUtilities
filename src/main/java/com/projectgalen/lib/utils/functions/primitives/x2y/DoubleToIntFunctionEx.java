...
// ================================================================================================================================
//     PROJECT: PGUtilities
//    FILENAME: DoubleToIntFunctionEx.java
//         IDE: IntelliJ IDEA
//      AUTHOR: Galen Rhodes
//        DATE: June 27, 2024
//
...
/**
 * Represents a function that accepts an double-valued argument and produces a int-valued result.  This is the {@code double}-to-{@code int} primitive specialization for
 ...
 */
@FunctionalInterface
public interface DoubleToIntFunctionEx<E extends Exception> {
