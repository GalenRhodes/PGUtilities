...
// ================================================================================================================================
//     PROJECT: PGUtilities
//    FILENAME: DoubleToLongFunctionEx.java
//         IDE: IntelliJ IDEA
//      AUTHOR: Galen Rhodes
//        DATE: June 27, 2024
//
...
/**
 * Represents a function that accepts an double-valued argument and produces a long-valued result.  This is the {@code double}-to-{@code long} primitive specialization for
 ...
 */
@FunctionalInterface
public interface DoubleToLongFunctionEx<E extends Exception> {
