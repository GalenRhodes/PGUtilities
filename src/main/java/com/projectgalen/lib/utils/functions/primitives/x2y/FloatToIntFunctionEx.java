...
// ================================================================================================================================
//     PROJECT: PGUtilities
//    FILENAME: FloatToIntFunctionEx.java
//         IDE: IntelliJ IDEA
//      AUTHOR: Galen Rhodes
//        DATE: June 26, 2024
//
...
/**
 * Represents a function that accepts an float-valued argument and produces a int-valued result.  This is the {@code float}-to-{@code int} primitive specialization for
 ...
 */
@FunctionalInterface
public interface FloatToIntFunctionEx<E extends Exception> {
