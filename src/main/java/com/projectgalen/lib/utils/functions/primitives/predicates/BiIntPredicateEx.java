...
// ================================================================================================================================
//     PROJECT: PGUtilities
//    FILENAME: BiIntPredicateEx.java
//         IDE: IntelliJ IDEA
//      AUTHOR: Galen Rhodes
//        DATE: July 01, 2024
//
...
@FunctionalInterface
public interface BiIntPredicateEx<E extends Exception> {
     ...
     */
    default @NotNull BiIntPredicateEx<? extends E> and(@NotNull BiIntPredicateEx<? extends E> other) {
     ...
     */
    default @NotNull BiIntPredicateEx<? extends E> negate() {
     ...
     * @throws NullPointerException if other is null
     */
    default @NotNull BiIntPredicateEx<? extends E> or(@NotNull BiIntPredicateEx<? extends E> other) {
        return (int t, int u) -> (test(t, u) || other.test(t, u));
    }
}
