...
/**
 * Represents a predicate (boolean-valued function) of one {@code int}-valued argument. This is the {@code int}-consuming primitive type specialization of {@link java.util.function.Predicate}.
 *
...
@FunctionalInterface
public interface IntPredicateEx<E extends Exception> {
     ...
     */
    default @NotNull IntPredicateEx<? extends E> and(@NotNull IntPredicateEx<? extends E> other) {
     ...
     */
    default @NotNull IntPredicateEx<? extends E> negate() {
     ...
     * @throws NullPointerException if other is null
     */
    default @NotNull IntPredicateEx<? extends E> or(@NotNull IntPredicateEx<? extends E> other) {
        return (value) -> test(value) || other.test(value);
    }
}
