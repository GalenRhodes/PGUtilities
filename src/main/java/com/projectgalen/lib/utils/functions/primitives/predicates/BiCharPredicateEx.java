...
// ================================================================================================================================
//     PROJECT: PGUtilities
//    FILENAME: BiCharPredicateEx.java
//         IDE: IntelliJ IDEA
//      AUTHOR: Galen Rhodes
//        DATE: July 01, 2024
//
...
/**
 * Represents a predicate (boolean-valued function) of two {@code char}-valued arguments.  This is the char-consuming primitive type specialization of {@link java.util.function.BiPredicate}.
 *
...
@FunctionalInterface
public interface BiCharPredicateEx<E extends Exception> {
     ...
     */
    default @NotNull BiCharPredicateEx<? extends E> and(@NotNull BiCharPredicateEx<? extends E> other) {
        return (char t, char u) -> (test(t, u) && other.test(t, u));
    }
     ...
     */
    default @NotNull BiCharPredicateEx<? extends E> negate() {
        return (char t, char u) -> (!test(t, u));
    }
     ...
     * @throws NullPointerException if other is null
     */
    default @NotNull BiCharPredicateEx<? extends E> or(@NotNull BiCharPredicateEx<? extends E> other) {
        return (char t, char u) -> (test(t, u) || other.test(t, u));
    }
}
