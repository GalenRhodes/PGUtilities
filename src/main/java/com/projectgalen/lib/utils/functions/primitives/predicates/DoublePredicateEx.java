...
// ================================================================================================================================
//     PROJECT: PGUtilities
//    FILENAME: DoublePredicateEx.java
//         IDE: IntelliJ IDEA
//      AUTHOR: Galen Rhodes
//        DATE: July 01, 2024
//
...
/**
 * Represents a predicate (boolean-valued function) of one {@code double}-valued argument. This is the {@code double}-consuming primitive type specialization of {@link java.util.function.Predicate}.
 *
...
@FunctionalInterface
public interface DoublePredicateEx<E extends Exception> {
     ...
     */
    default @NotNull DoublePredicateEx<? extends E> and(@NotNull DoublePredicateEx<? extends E> other) {
     ...
     */
    default @NotNull DoublePredicateEx<? extends E> negate() {
     ...
     * @throws NullPointerException if other is null
     */
    default @NotNull DoublePredicateEx<? extends E> or(@NotNull DoublePredicateEx<? extends E> other) {
        return (value) -> test(value) || other.test(value);
    }
}
