 ...
 * {@code (reference, int)} specialization of {@link com.projectgalen.lib.utils.functions.BiConsumerEx}.
 * Unlike most other functional interfaces, {@code ObjIntConsumerEx} is
