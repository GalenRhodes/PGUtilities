...
// ================================================================================================================================
//     PROJECT: PGUtilities
//    FILENAME: IntUnaryOperatorEx.java
//         IDE: IntelliJ IDEA
//      AUTHOR: Galen Rhodes
//        DATE: June 27, 2024
//
...
/**
 * Represents a function that accepts an int-valued argument and produces a int-valued result.  This is the {@code int}-to-{@code int} primitive specialization for
 ...
 */
@FunctionalInterface
public interface IntUnaryOperatorEx<E extends Exception> {
