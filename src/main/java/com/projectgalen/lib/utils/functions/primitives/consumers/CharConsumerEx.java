 ...
 * {@link com.projectgalen.lib.utils.functions.ConsumerEx} for {@code char}.  Unlike most other functional interfaces,
 * {@code CharConsumerEx} is expected to operate via side-effects.
 *
...
public interface CharConsumerEx<E extends Exception> {
    ...
    /**
     * Returns a composed {@code CharConsumerEx} that performs, in sequence, this
     ...
     * @return a composed {@code CharConsumerEx} that performs in sequence this
