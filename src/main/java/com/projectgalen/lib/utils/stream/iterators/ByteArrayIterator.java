...
// ================================================================================================================================
//     PROJECT: PGUtilities
//    FILENAME: ByteArrayIterator.java
//         IDE: IntelliJ IDEA
//      AUTHOR: Galen Rhodes
//        DATE: May 07, 2024
//
...
public class ByteArrayIterator implements Iterator<ByteArrayIterator.Item> {
    ...
    public ByteArrayIterator(byte @NotNull ... array) {
        this(array, 0, array.length);
    }

    public ByteArrayIterator(byte @NotNull [] array, int pos, int length) {
        this.array = array;
        this.idx   = pos;
     ...
     */
    public @Override ByteArrayIterator.Item next() {
        if(!hasNext()) throw new NoSuchElementException();
        int i = idx++;
        return new Item(i, array[i]);
    }

    public record Item(int idx, byte value) implements Comparable<Item> {
