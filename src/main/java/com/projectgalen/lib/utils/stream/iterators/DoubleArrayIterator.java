...
// ================================================================================================================================
//     PROJECT: PGUtilities
//    FILENAME: DoubleArrayIterator.java
//         IDE: IntelliJ IDEA
//      AUTHOR: Galen Rhodes
//        DATE: May 07, 2024
//
...
public class DoubleArrayIterator implements Iterator<DoubleArrayIterator.Item> {
    ...
    public DoubleArrayIterator(double @NotNull ... array) {
        this(array, 0, array.length);
    }

    public DoubleArrayIterator(double @NotNull [] array, int pos, int length) {
        this.array = array;
        this.idx   = pos;
     ...
     */
    public @Override DoubleArrayIterator.Item next() {
        if(!hasNext()) throw new NoSuchElementException();
        int i = idx++;
        return new Item(i, array[i]);
    }

    public record Item(int idx, double value) implements Comparable<Item> {
