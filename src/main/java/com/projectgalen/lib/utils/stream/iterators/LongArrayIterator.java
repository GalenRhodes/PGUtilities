...
// ================================================================================================================================
//     PROJECT: PGUtilities
//    FILENAME: LongArrayIterator.java
//         IDE: IntelliJ IDEA
//      AUTHOR: Galen Rhodes
//        DATE: May 07, 2024
//
...
public class LongArrayIterator implements Iterator<LongArrayIterator.Item> {
    ...
    public LongArrayIterator(long @NotNull ... array) {
        this(array, 0, array.length);
    }

    public LongArrayIterator(long @NotNull [] array, int pos, int length) {
        this.array = array;
        this.idx   = pos;
     ...
     */
    public @Override LongArrayIterator.Item next() {
        if(!hasNext()) throw new NoSuchElementException();
        int i = idx++;
        return new Item(i, array[i]);
    }

    public record Item(int idx, long value) implements Comparable<Item> {
