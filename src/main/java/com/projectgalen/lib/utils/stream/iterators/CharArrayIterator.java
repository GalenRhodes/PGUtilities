...
// ================================================================================================================================
//     PROJECT: PGUtilities
//    FILENAME: CharArrayIterator.java
//         IDE: IntelliJ IDEA
//      AUTHOR: Galen Rhodes
//        DATE: May 07, 2024
//
...
public class CharArrayIterator implements Iterator<CharArrayIterator.Item> {
    ...
    public CharArrayIterator(char @NotNull ... array) {
        this(array, 0, array.length);
    }

    public CharArrayIterator(char @NotNull [] array, int pos, int length) {
        this.array = array;
        this.idx   = pos;
     ...
     */
    public @Override CharArrayIterator.Item next() {
        if(!hasNext()) throw new NoSuchElementException();
        int i = idx++;
        return new Item(i, array[i]);
    }

    public record Item(int idx, char value) implements Comparable<Item> {
