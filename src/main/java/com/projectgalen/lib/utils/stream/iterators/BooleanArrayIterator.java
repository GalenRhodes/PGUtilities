...
// ================================================================================================================================
//     PROJECT: PGUtilities
//    FILENAME: BooleanArrayIterator.java
//         IDE: IntelliJ IDEA
//      AUTHOR: Galen Rhodes
//        DATE: May 07, 2024
//
...
public class BooleanArrayIterator implements Iterator<BooleanArrayIterator.Item> {
    ...
    public BooleanArrayIterator(boolean @NotNull ... array) {
        this(array, 0, array.length);
    }

    public BooleanArrayIterator(boolean @NotNull [] array, int pos, int length) {
        this.array = array;
        this.idx   = pos;
     ...
     */
    public @Override BooleanArrayIterator.Item next() {
        if(!hasNext()) throw new NoSuchElementException();
        int i = idx++;
        return new Item(i, array[i]);
    }

    public record Item(int idx, boolean value) implements Comparable<Item> {
