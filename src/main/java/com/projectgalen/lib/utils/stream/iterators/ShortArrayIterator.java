...
// ================================================================================================================================
//     PROJECT: PGUtilities
//    FILENAME: ShortArrayIterator.java
//         IDE: IntelliJ IDEA
//      AUTHOR: Galen Rhodes
//        DATE: May 07, 2024
//
...
public class ShortArrayIterator implements Iterator<ShortArrayIterator.Item> {
    ...
    public ShortArrayIterator(short @NotNull ... array) {
        this(array, 0, array.length);
    }

    public ShortArrayIterator(short @NotNull [] array, int pos, int length) {
        this.array = array;
        this.idx   = pos;
     ...
     */
    public @Override ShortArrayIterator.Item next() {
        if(!hasNext()) throw new NoSuchElementException();
        int i = idx++;
        return new Item(i, array[i]);
    }

    public record Item(int idx, short value) implements Comparable<Item> {
