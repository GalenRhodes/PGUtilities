...
public final class CryptoTools {
    public static final PGResourceBundle msgs  = new PGResourceBundle("com.projectgalen.lib.crypto.crypto_messages");
    public static final PGProperties     props = PGProperties.getProperties("crypto_settings.properties", Crypto.class);
    ...
    public static byte @NotNull [] createSharedSecretDigest(@NotNull PrivateKey privateKey, byte @NotNull [] publicKeyBytes) throws GeneralSecurityException {
        KeyFactory keyFactory = KeyFactory.getInstance(getDHAlgorithm(), getProviderName());
    ...
    public static @NotNull KeyPair generateKeyPair() throws GeneralSecurityException {
        return generateKeyPair(getDefaultDHKeyLength());
    }

    public static @NotNull KeyPair generateKeyPair(int bitLength) throws GeneralSecurityException {
        KeyPairGenerator keyGen = KeyPairGenerator.getInstance(getDHAlgorithm(), getProviderName());
    ...
    public static String getDHAlgorithm() {
        return props.getProperty("crypto.diffie_hellman.algorithm");
    }

    public static int getDefaultDHKeyLength() {
        return props.getInt("crypto.diffie_hellman.key_length", 2048);
    }

    public static @NotNull KeyAgreement getKeyAgreement(@NotNull PrivateKey privateKey) throws GeneralSecurityException {
        KeyAgreement keyAgree = KeyAgreement.getInstance(getDHAlgorithm(), getProviderName());
    ...
    public static String getProviderName() {
        return props.getProperty("crypto.bouncy-castle.provider");
    }
